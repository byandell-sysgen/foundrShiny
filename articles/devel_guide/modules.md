...
``` mermaid
flowchart TD
    subgraph Infra["1. Application Infrastructure"]
        app["foundrApp & panelServer"]
        entry["entryServer (Auth)"]
        download["downloadApp"]
    end

    subgraph Params["2. Parameter Tier Modules"]
        params["mainPar, panelPar, plotPar"]
    end
    ...
    class app,entry,download infra
    class params param
